...
public class DeleteArticleController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.deleleArticle(id);
            request.setAttribute("DELETE_ARTICLE_SUCCESS", "Your article has been deleted successfully!!");
            url = SUCCESS;
        } catch (ClassNotFoundException | SQLException | NamingException e) {
            LOGGER.fatal("Error at DeleteArticleController: ", e);
        } finally {
