 ...
 * @author SE130205
 */
public class SearchAllArticleController extends HttpServlet {

    private static final String ERROR = "invalid.jsp";
    private static final String SUCCESS = "homePage.jsp";
    private static final Logger LOGGER = Logger.getLogger(SearchAllArticleController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ArticleDTO> list = dao.getAllArticle(curPage);
            request.setAttribute("LIST_ARTICLE", list);
            request.setAttribute("CUR_PAGE", curPage);
            url = SUCCESS;
        } catch (ClassNotFoundException | SQLException | NamingException e) {
            LOGGER.fatal("Error at SearchAllArticleController: ", e);
        } finally {
