<%-- 
    Document   : invalid
    Created on : Oct 1, 2020, 3:18:50 AM
    Author     : SE130205
--%>
                ...
                <div class="row" style="padding-top: 20%">
                    ...
                    <div class="col-md-6 align-self-center">
                        ...
                        <c:if test="${sessionScope.USER != null && not empty sessionScope.USER}">
                            <a href="MainController?btnAction=SearchAll" class="btn btn-outline-secondary">HOME</a>
                        </c:if>
                        <c:if test="${sessionScope.USER == null || empty sessionScope.USER}">
                            <a href="loginPage.jsp" class="btn btn-outline-secondary">LOGIN PAGE</a>
                        </c:if>
                    </div>
                </div>
            </div>
